...
const Hero = () => {
  ...
  return (
    <section className="max-w-[2024px] mx-auto w-[90%] h-[auto] lg:min-h-screen flex flex-col gap-5 xl:flex-row justify-center items-center text-white text-center py-6 lg:px-20 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center w-full">
        <div className="tet-center w-fit mx-center text-white py-4 px-8 rounded-xl">
          <p className="text-2xl md:text-4xl lg:text-5xl text-inherit font-Thicccboi">
