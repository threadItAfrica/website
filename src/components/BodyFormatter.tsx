      ...
      <PortableText
        ...
        components={{
          block: {
            ...
            h1: ({ children }) => (
              <h1 className="text-gray-700 text-md md:text-lg mt-4 mb-2  font-[600] flex gap-2 items-center">
                <span className="hidden md:block rounded-full w-[13px] h-[13px] bg-primary"></span>
                {children}
              </h1>
            ),
            h2: ({ children }) => (
              <h2 className="text-gray-700 text-md md:text-lg mt-4 mb-2  font-[600] flex gap-2 items-center">
                <span className="hidden md:block rounded-full w-[13px] h-[13px] bg-primary"></span>
                {children}
              </h2>
            ),
            h3: ({ children }) => (
              <h3 className="text-gray-700 text-md md:text-lg mt-4 mb-2 font-[600] flex gap-2 items-center">
                <span className="hidden md:block rounded-full w-[13px] h-[13px] bg-primary"></span>
                {children}
              </h3>
            ),
